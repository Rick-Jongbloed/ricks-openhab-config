...
import EasyRule
from EasyRule.openhab.log import log_traceback
...
EasyRule.openhab.DIRECTORY_TRIGGER_MODULE_ID = "jsr223.DirectoryTrigger"

def scriptLoaded(*args):
    scope.automationManager.addTriggerHandler(
        EasyRule.openhab.DIRECTORY_TRIGGER_MODULE_ID, 
...
def scriptUnloaded():
    scope.automationManager.removeHandler(EasyRule.openhab.DIRECTORY_TRIGGER_MODULE_ID)
    scope.automationManager.removeModuleType(EasyRule.openhab.DIRECTORY_TRIGGER_MODULE_ID)
